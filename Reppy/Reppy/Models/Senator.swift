...
struct SenatorFetch: Codable {
    var results: [SenatorResults]
    ...
    enum CodingKeys: String, CodingKey {
        ...
        let results: [SenatorResults] = try container.decode([SenatorResults].self, forKey: .results)
...
struct  SenatorResults: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        init(from decoder: Decoder) throws {
           ...
           let container = try decoder.container(keyedBy: CodingKeys.self)
            let congress = try container.decode(String.self, forKey: .congress)
            let chamber = try container.decode(String.self, forKey: .chamber)
            let members: [Senator] = try container.decode([Senator].self, forKey: .members)
...
struct Senator: Codable {
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case missedVotesPercentage = "missed_votes_pct"
